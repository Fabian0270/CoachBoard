    ...
    for (let w = 0; w < weekCols.length; w++) {
      ...
      exercises.push({
        ...
        refillCols: {
          ...
          loadCap: fields.loadCap !== null ? base + fields.loadCap : null,
          intensity: fields.intensity !== null ? base + fields.intensity : null,
          restTime: fields.restTime !== null ? base + fields.restTime : null,
